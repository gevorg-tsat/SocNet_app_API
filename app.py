...
get_db, edit_post, delete_post, get_user_by_username, get_post_by_id
...
@app.get("/user/{username}/posts/", response_model=list[schema.Post])
...
@app.get("/posts/{post_id}", response_model=schema.PostWithLikes)
...
@app.post("/posts/{post_id}/like", response_model=schema.PostWithLikes)
async def like_post(
